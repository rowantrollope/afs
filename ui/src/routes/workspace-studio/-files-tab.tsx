...
import { InlineActions, MetaRow, Tag } from "../../components/afs-kit";
...
export function FilesTab({
  ...
  const viewOptions = useMemo(
    () => getWorkspaceBrowserViewOptions(workspace),
    [workspace],
  );
                ...
                <DrawerHeader>
                  <DrawerTitleWrap>
                    ...
                    <ViewerMeta>
                      ...
                      {formatItemSize(selectedFile.size)}
                    </ViewerMeta>
                  </DrawerTitleWrap>
                  <InlineActions>
                    <Button
...
const FileTableHeader = styled.th<{
  $name?: boolean;
  $size?: boolean;
  $time?: boolean;
}>`
