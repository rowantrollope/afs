...
describe("SettingsTab versioning controls", () => {
  ...
  test("shows content storage and versioning without the removed search feature", () => {
    render(
    ...
    expect(screen.queryByText("Exact search index")).not.toBeInTheDocument();
    expect(screen.queryByText("Search Index")).not.toBeInTheDocument();
    expect(screen.getByText("Transparent file versioning")).toBeInTheDocument();
  });
